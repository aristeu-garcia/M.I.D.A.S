...
class RoundedTextFieldPassword extends StatefulWidget {
  final TextEditingController controller;
  final bool obscureText;

  const RoundedTextFieldPassword({
    Key? key,
...
class _RoundedTextFieldState extends State<RoundedTextFieldPassword> {
